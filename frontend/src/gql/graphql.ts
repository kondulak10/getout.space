...
export type UserHexagonsForStatsQuery = { userHexagons: Array<{ __typename: 'Hexagon', id: string, hexagonId: string, captureCount: number, firstCapturedAt: unknown, lastCapturedAt: unknown, currentOwnerId: string, firstCapturedBy: { __typename: 'User', id: string } | null, captureHistory: Array<{ __typename: 'CaptureHistoryEntry', userId: string, stravaId: number, capturedAt: unknown }> }> };
...
export type HexagonsStolenFromUserQuery = { hexagonsStolenFromUser: Array<{ __typename: 'Hexagon', id: string, hexagonId: string, currentOwnerId: string, currentOwnerStravaId: number, captureHistory: Array<{ __typename: 'CaptureHistoryEntry', userId: string, stravaId: number, capturedAt: unknown }> }> };
