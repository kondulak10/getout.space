...
export type MeQuery = { me: { __typename: 'User', id: string, stravaId: number, isAdmin: boolean, isPremium: boolean, tokenExpiresAt: number, tokenIsExpired: boolean, scope: string, lastHex: string | null, createdAt: unknown, updatedAt: unknown, stravaProfile: { __typename: 'StravaProfile', firstname: string, lastname: string, profile: string | null, imghex: string | null, city: string | null, state: string | null, country: string | null, sex: string | null, username: string | null } } | null };
...
export type HexagonDetailQuery = { hexagon: { __typename: 'Hexagon', hexagonId: string, captureCount: number, firstCapturedAt: unknown, lastCapturedAt: unknown, currentOwner: { __typename: 'User', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, profile: string | null } } | null, firstCapturedBy: { __typename: 'User', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, profile: string | null } } | null, currentActivity: { __typename: 'Activity', id: string, stravaActivityId: number, name: string, distance: number, averageSpeed: number, startDateLocal: unknown, movingTime: number } | null, captureHistory: Array<{ __typename: 'CaptureHistoryEntry', userId: string, stravaId: number, activityId: string, stravaActivityId: number, capturedAt: unknown, activityType: string, user: { __typename: 'User', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, profile: string | null } } | null, activity: { __typename: 'Activity', id: string, stravaActivityId: number, distance: number, averageSpeed: number, startDateLocal: unknown } | null }> } | null };
...
export type RegionalActiveLeadersQuery = { regionalActiveLeaders: Array<{ __typename: 'LeaderboardEntry', hexCount: number, user: { __typename: 'User', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, lastname: string, profile: string | null, imghex: string | null } } }> };
...
export type RegionalOgDiscoverersQuery = { regionalOGDiscoverers: Array<{ __typename: 'LeaderboardEntry', hexCount: number, user: { __typename: 'User', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, lastname: string, profile: string | null, imghex: string | null } } }> };
