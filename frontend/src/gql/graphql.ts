...
export type LeaderboardCache = {
  __typename: 'LeaderboardCache';
  entries: Array<LeaderboardEntry>;
  lastUpdated: Scalars['Date']['output'];
  nextUpdate: Scalars['Date']['output'];
  type: Scalars['String']['output'];
};
...
export type LeaderboardEntry = {
  ...
  hexagonCount: Scalars['Int']['output'];
  imghex: Scalars['String']['output'];
...
export type Query = {
   ...
   */
  globalLeaderboard: Array<LeaderboardEntry>;
  /**
  ...
  leaderboardCache: Maybe<LeaderboardCache>;
  /**
   ...
   */
  myGlobalRank: Maybe<Scalars['Int']['output']>;
  /**
...
export type NotificationFieldsFragment = { __typename: 'Notification', id: string, type: NotificationType, message: string, read: boolean, relatedActivityId: string | null, createdAt: unknown, triggeredBy: { __typename: 'UserPublic', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, lastname: string, imghex: string | null } } | null };
...
export type MyNotificationsQuery = { myNotifications: Array<{ __typename: 'Notification', id: string, type: NotificationType, message: string, read: boolean, relatedActivityId: string | null, createdAt: unknown, triggeredBy: { __typename: 'UserPublic', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, lastname: string, imghex: string | null } } | null }> };
...
export type MarkNotificationAsReadMutation = { markNotificationAsRead: { __typename: 'Notification', id: string, type: NotificationType, message: string, read: boolean, relatedActivityId: string | null, createdAt: unknown, triggeredBy: { __typename: 'UserPublic', id: string, stravaId: number, stravaProfile: { __typename: 'StravaProfile', firstname: string, lastname: string, imghex: string | null } } | null } };
...
export type UpdateEmailMutation = { updateEmail: { __typename: 'User', id: string, email: string | null } };
...
export type UserBattleStatsQueryVariables = Exact<{
  userId: Scalars['ID']['input'];
}>;


export type UserBattleStatsQuery = { userBattleStats: { __typename: 'UserBattleStats', ogHexagons: number, conqueredHexagons: number, cleanTerritory: number, totalHexagons: number } };

export type UserRecordStatsQueryVariables = Exact<{
  userId: Scalars['ID']['input'];
}>;


export type UserRecordStatsQuery = { userRecordStats: { __typename: 'UserRecordStats', mostContested: { __typename: 'RecordHexagon', hexagonId: string, captureCount: number, lastCapturedAt: unknown } | null, longestHeld: { __typename: 'RecordHexagon', hexagonId: string, captureCount: number, lastCapturedAt: unknown } | null } };

export type GlobalLeaderboardQueryVariables = Exact<{ [key: string]: never; }>;


export type GlobalLeaderboardQuery = { globalLeaderboard: Array<{ __typename: 'LeaderboardEntry', userId: string, stravaId: number, username: string, imghex: string, profileImageUrl: string | null, hexagonCount: number, activityCount: number, totalDistance: number, rank: number }> };

export type MyGlobalRankQueryVariables = Exact<{ [key: string]: never; }>;


export type MyGlobalRankQuery = { myGlobalRank: number | null };
...
export const UserBattleStatsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UserBattleStats"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userBattleStats"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"ogHexagons"}},{"kind":"Field","name":{"kind":"Name","value":"conqueredHexagons"}},{"kind":"Field","name":{"kind":"Name","value":"cleanTerritory"}},{"kind":"Field","name":{"kind":"Name","value":"totalHexagons"}}]}}]}}]} as unknown as DocumentNode<UserBattleStatsQuery, UserBattleStatsQueryVariables>;
export const UserRecordStatsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UserRecordStats"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userRecordStats"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"userId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"mostContested"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hexagonId"}},{"kind":"Field","name":{"kind":"Name","value":"captureCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastCapturedAt"}}]}},{"kind":"Field","name":{"kind":"Name","value":"longestHeld"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hexagonId"}},{"kind":"Field","name":{"kind":"Name","value":"captureCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastCapturedAt"}}]}}]}}]}}]} as unknown as DocumentNode<UserRecordStatsQuery, UserRecordStatsQueryVariables>;
export const GlobalLeaderboardDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GlobalLeaderboard"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"globalLeaderboard"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userId"}},{"kind":"Field","name":{"kind":"Name","value":"stravaId"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"imghex"}},{"kind":"Field","name":{"kind":"Name","value":"profileImageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"hexagonCount"}},{"kind":"Field","name":{"kind":"Name","value":"activityCount"}},{"kind":"Field","name":{"kind":"Name","value":"totalDistance"}},{"kind":"Field","name":{"kind":"Name","value":"rank"}}]}}]}}]} as unknown as DocumentNode<GlobalLeaderboardQuery, GlobalLeaderboardQueryVariables>;
export const MyGlobalRankDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MyGlobalRank"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myGlobalRank"}}]}}]} as unknown as DocumentNode<MyGlobalRankQuery, MyGlobalRankQueryVariables>;