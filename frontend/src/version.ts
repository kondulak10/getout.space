...
export const APP_VERSION = "1011-19071";
export const BUILD_TIMESTAMP = "2025-11-10T18:07:21.878Z";
...
export const logVersion = () => {
	...
	console.log("%c║          🚀 GetOut.space LOADED           ║", styles.title);
	console.log("%c╠═══════════════════════════════════════════╣", styles.border);
	console.log(`%c║  Version: ${getVersionString().padEnd(30, " ")}║`, styles.version);
	console.log(`%c║  Build: ${BUILD_TIMESTAMP.split("T")[0].padEnd(32, " ")}║`, styles.info);
	console.log(
